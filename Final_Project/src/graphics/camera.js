...
class Camera {
    ...
    */
    constructor(shader) {
        ...
        this.eye     = new Vector3([-0.5, 1, 15.5]);
        // this.eye     = new Vector3([14, 1, 16]);

        // this.center  = new Vector3([-1, 1, 6]);
        // this.center  = new Vector3([0, 0.75, 5]);
        this.center  = new Vector3([-0.5, 1, 4.5]);

        // this.center  = new Vector3([14, 0.75, 5]);
        ...
        this.projectionMatrix.setPerspective(60, 1, 0.1, 50);
        // this.projectionMatrix.lookAt(eye[0], eye[1], eye[2], 0, 2, 0, 0, 1, 0);
        // this.projectionMatrix.mutiply(modelMatrix);
    }
    ...
    truck(dir) {
        ...
        //returns value in order to move light
        return u;
    }
